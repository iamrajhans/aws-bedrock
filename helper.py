...
def prepare_agent_and_check_status(bedrockAgent, agentId):
    """
    Args:
        agentId (str): Id of the bedrock agent
        bedrock_agent (obj): boto3 bedrock-agent client
    """
    bedrockAgent.prepare_agent(
        agentId=agentId
    )
...
def update_agent_alias_and_check_status(bedrockAgent, agentId, agentAliasId):
    """
    Args:
        bedrockAgent (obj): boto3 bedrock-agent client
        agentId (str): Id of the bedrock agent
        agentAliasId (str): Id of the agent alias
    """
    bedrockAgent.update_agent_alias(
        agentId=agentId,
        agentAliasId=agentAliasId,
